...
def get_feat_matrices(contemp, monthly, annual, depth_sampled=-0.556543241, satellite_month=0, monthly_month=0, year_sampled=0, month_sampled=0, satellite_feats=satellite_feats, monthly_feats=monthly_feats, annual_feats=annual_feats, year_sampled_feats=year_sampled_feats, month_sampled_feats=month_sampled_feats):
...
def create_prediction_matrix(contemp, monthly, annual, gene, depth_sampled=-0.556543241, satellite_month=0, monthly_month=0, year_sampled=0, month_sampled=0, satellite_feats=satellite_feats, monthly_feats=monthly_feats, annual_feats=annual_feats, year_sampled_feats=year_sampled_feats, month_sampled_feats=month_sampled_feats):
    print("creating feature matrices...")
    feat_matrix = get_feat_matrices(contemp, monthly, annual, depth_sampled=-0.556543241, satellite_month=0, monthly_month=0, year_sampled=0, month_sampled=0, satellite_feats=satellite_feats, monthly_feats=monthly_feats, annual_feats=annual_feats, year_sampled_feats=year_sampled_feats, month_sampled_feats=month_sampled_feats)
